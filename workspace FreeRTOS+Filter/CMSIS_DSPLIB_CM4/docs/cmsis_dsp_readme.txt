CMSIS DSP Library (Cortex-M4 with floating point)
=================================================
This project provides a pre-built version of ARM's CMSIS
DSP Library, built at optimisation level -O2.

This library is suitable for use by a application
project which has been created with support for the 
Cortex-M4's floating point unit enabled (using Soft ABI).
